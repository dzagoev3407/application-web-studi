...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4 text-white text-center">Ajouter une cible</h1>
...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="addCibles.php" method="POST">
					<span class="login100-form-title p-b-26">
						Ajouter une cible
					</span>
					<span class="login100-form-title p-b-48">
            <img src="https://cdn-icons-png.flaticon.com/512/116/116370.png" alt="Mission-logo" width="60px" heigth="60px">
					</span>
          ...
          <div class="wrap-input100 validate-input">
                <label>Code de la cible : </label>
                <input type="text" name="codeCible" required>
		  </div>
