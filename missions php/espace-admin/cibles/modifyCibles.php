...
<table class="table table-dark">
  ...
  <tbody>
    <?php while($cibles = $displayCibles->fetch()){
      
      ?>
    <tr>
      <td><?php echo $cibles['nom']?></td>
      <td><?php echo $cibles['prenom']?></td>
      <td><?php echo $cibles['date_naissance']?></td>
      <td><?php echo $cibles['code']?></td>
      <td><?php echo $cibles['nationnalite']?></td>
      <td><a href="deleteCibles.php?id=<?= $cibles['id'] ?>"><button class="btn btn-danger">Supprimer</button></td>
    </tr>
